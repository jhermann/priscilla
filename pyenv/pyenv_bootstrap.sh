...
: ${SNAKES:=2.6.9 2.7.11 3.3.6 3.4.4 3.5.1} # add versions in SORTED order
: ${VENV_SRC:=https://pypi.python.org/packages/source/v/virtualenv/virtualenv-15.0.1.tar.gz}
